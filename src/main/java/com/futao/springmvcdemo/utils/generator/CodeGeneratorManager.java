package com.futao.springmvcdemo.utils.generator;
...
public class CodeGeneratorManager {
     ...
     * 项目基础路径
     */
    private static final String PROJECT_BASE_PATH = System.getProperty("user.dir") + "/src/main/java/com/futao/springmvcdemo";
    /**
     * 模板文件路径
     */
